...
## Project Overview
This project predicts passenger survival on the Titanic using machine learning (Logistic Regression). Built as part of the AIML Industry Readiness Program.

## Business Objective
Build a classification model that predicts survival and provides clear interpretability regarding key factors (e.g., gender, class, family size) influencing survival odds.
